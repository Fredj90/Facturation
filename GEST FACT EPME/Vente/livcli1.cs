...
{
    public partial class livcli1 : System.Windows.Forms.Form
    {
        ...
        private void livcli1_Load(object sender, EventArgs e)
        {
        ...
        private void charger_lignefacture()
        {
            ...
            if (dataGridViewX1.SelectedRows.Count != 0)
            {
                ...
                string req1 = "select distinct  l.num,l.codea, a.libelle , g.libelle as gamme , d.libelle as depot , l.qte , l.pu , l.tva , l.taxe,l.tvaf , l.rem , l.netht , l.netttc,l.codesa,l.ID   from lentl l , article a , gamme g , depot d where l.codes='" + Program.Societe + "' and l.codee='" + Program.Exercice + "' and l.num= '" + dataGridViewX1.SelectedRows[0].Cells["num"].Value + "' and  l.codem='" + Program.Magasin + "' and l.codea = a.code and l.codes= a.codes and l.codee= a.codee and l.codea = g.codea and l.codeg=g.codeg  and l.codes=g.codes and l.codee=g.codee and l.coded= d.code and l.codes=d.codes and l.codee=d.codee and l.codem=d.codem ";
                DataSet ds1 = met.recuperer_table(req1, "lentl");

                foreach (DataRow dr in ds1.Tables["lentl"].Rows)
                {
                ...
                dataGridViewX2.DataSource = ds1.Tables["lentl"].DefaultView;
        ...
        private void buttonX3_Click(object sender, EventArgs e)
        {
            ...
            {
                string sql = "select * from eentl where codes = '" + Program.Societe + "' and codee = '" + Program.Exercice + "' and codem='" + Program.Magasin + "' and num = '" + dataGridViewX1.SelectedRows[0].Cells["NuM"].Value + "' and facture = false";
                DataSet dss = met.recuperer_table(sql, "eentl");
                if (dss.Tables["eentl"].Rows.Count != 0)
                {
                    ...
                    if (msg.Equals("Yes"))
                    {
                        ...
                        string req1 = "Select * from lentl where codes='" + Program.Societe + "' and codee='" + Program.Exercice + "' and codem='" + Program.Magasin + "'  and  num = '" + dataGridViewX1.SelectedRows[0].Cells["NuM"].Value + "' ";
                        DataSet tmp1 = met.recuperer_table(req1, "lentl");
                        foreach (DataRow dr1 in tmp1.Tables["lentl"].Rows)
                        {
                        ...
                        try
                        {
                            decimal.TryParse(dataGridViewX1.SelectedRows[0].Cells[4].Value + "", out xven);
                        }
                        catch { }
                        nven = wven - xven;
                        ...
                        String req3 = "DELETE FROM eentl Where codes = '" + Program.Societe + "' and codee = '" + Program.Exercice + "' and codem='" + Program.Magasin + "' and num = '" + dataGridViewX1.SelectedRows[0].Cells["NuM"].Value + "'";

                        if (met.Execute(req3))
                        {
                            String req4 = "DELETE FROM lentl Where codes = '" + Program.Societe + "' and codee = '" + Program.Exercice + "' and codem='" + Program.Magasin + "' and num = '" + dataGridViewX1.SelectedRows[0].Cells["NuM"].Value + "'";
                            if (met.Execute(req4))
                    ...
                    MessageBox.Show("Livraison déja Facturée", "Impossible");
            }
        }
        ...
        private void buttonX4_Click(object sender, EventArgs e)
        {
            ...
            if (dataGridViewX1.Rows.Count != 0)
            {
                ...
                {
                    DataRow[] dr = ds.Tables["eentl"].Select("num = '" + form.textBoxX3.Text + "'");
                    if (dr.Length != 0)
                    {
                ...
                else if (!form.code.Equals("0") && !form.dateTimeInput1.Text.Equals("") && !form.dateTimeInput2.Text.Equals(""))
                {
                    ...
                    string req2 = "select num,date,codec,nomc,totalht,fodec,totalrem,totaltva,totaltaxe,totalttc,facture from eentl where codes = '" + Program.Societe + "' and codee = '" + Program.Exercice + "' and codem='" + Program.Magasin + "'  and (codec='" + form.code + "' AND date>='" + ddebut + "' AND date<='" + dfin + "') order by num";
                    ds = met.recuperer_table(req2, "eentl");
                    dataGridViewX1.DataSource = ds.Tables["eentl"].DefaultView;
                    if (dataGridViewX1.Rows.Count != 0)
                    {
                        charger_lignefacture();
                        total();
                ...
                else if (!form.code.Equals("0") && !form.dateTimeInput1.Text.Equals(""))
                {
                    ...
                    string ddebut = form.dateTimeInput1.Value.ToString("yyyy-MM-dd");
                    string dfin = form.dateTimeInput2.Value.ToString("yyyy-MM-dd");
                    string req2 = "select num,date,codec,nomc,totalht,fodec,totalrem,totaltva,totaltaxe,totalttc,facture from eentl where codes = '" + Program.Societe + "' and codee = '" + Program.Exercice + "' and codem='" + Program.Magasin + "' and (codec='" + form.code + "' AND date>=#" + ddebut + "# ) order by num";
                    ds = met.recuperer_table(req2, "eentl");
                    dataGridViewX1.DataSource = ds.Tables["eentl"].DefaultView;
                    if (dataGridViewX1.Rows.Count != 0)
                    {
                ...
                else if (!form.code.Equals("0"))
                {
                    ...
                    string ddebut = form.dateTimeInput1.Value.ToString("yyyy-MM-dd");
                    string dfin = form.dateTimeInput2.Value.ToString("yyyy-MM-dd");
                    string req2 = "select num,date,codec,nomc,totalht,fodec,totalrem,totaltva,totaltaxe,totalttc,facture from eentl where codes = '" + Program.Societe + "' and codee = '" + Program.Exercice + "' and codem='" + Program.Magasin + "' and (codec='" + form.code + "') order by num";
                    ds = met.recuperer_table(req2, "eentl");
                    dataGridViewX1.DataSource = ds.Tables["eentl"].DefaultView;
                    if (dataGridViewX1.Rows.Count != 0)
                    {
                ...
                else if (form.code.Equals("0") && !form.dateTimeInput1.Text.Equals("") && !form.dateTimeInput2.Text.Equals(""))
                {
                    ...
                    string ddebut = form.dateTimeInput1.Value.ToString("yyyy-MM-dd");
                    string dfin = form.dateTimeInput2.Value.ToString("yyyy-MM-dd");
                    string req2 = "select num,date,codec,nomc,totalht,fodec,totalrem,totaltva,totaltaxe,totalttc,facture from eentl where codes = '" + Program.Societe + "' and codee = '" + Program.Exercice + "' and codem='" + Program.Magasin + "' and (date>='" + ddebut + "' AND date<='" + dfin + "') order by num";
                    ds = met.recuperer_table(req2, "eentl");
                    dataGridViewX1.DataSource = ds.Tables["eentl"].DefaultView;
                    if (dataGridViewX1.Rows.Count != 0)
                    {
                ...
                else if (form.code.Equals("0") && !form.dateTimeInput1.Text.Equals(""))
                {
                    ...
                    string ddebut = form.dateTimeInput1.Value.ToString("yyyy-MM-dd");
                    string dfin = form.dateTimeInput2.Value.ToString("yyyy-MM-dd");
                    string req2 = "select num,date,codec,nomc,totalht,fodec,totalrem,totaltva,totaltaxe,totalttc,facture from eentl where codes = '" + Program.Societe + "' and codee = '" + Program.Exercice + "' and codem='" + Program.Magasin + "' and (date>=#" + ddebut + "# ) order by num";
                    ds = met.recuperer_table(req2, "eentl");
                    dataGridViewX1.DataSource = ds.Tables["eentl"].DefaultView;
                    if (dataGridViewX1.Rows.Count != 0)
                    {
        ...
        private void livcli1_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
        ...
        private void buttonX1_Click(object sender, EventArgs e)
        {
            ...
            string req = "select num,date,codec,nomc,totalht,fodec,totalrem,totaltva,totaltaxe,totalttc,facture from eentl where codes = '" + Program.Societe + "' and codee = '" + Program.Exercice + "' and codem='" + Program.Magasin + "'  order by num";
            ds = met.recuperer_table(req, "eentl");
            dataGridViewX1.DataSource = ds.Tables["eentl"].DefaultView;
            if (dataGridViewX1.Rows.Count != 0)
            {
                if (first)
        ...
        private void total()
        {
            ...
            foreach (DataRow dr in ds.Tables["eentl"].Rows)
            {
        ...
        private void livcli1_FormClosed(object sender, FormClosedEventArgs e)
        {
        ...
        private void dataGridViewX1_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            foreach (DataGridViewRow dgr in dataGridViewX1.Rows)
            {
                ...
                if (xtype)
                {
                    ...
                    dgr.Cells["facture"].Style.ForeColor = Color.Black;
                    dgr.Cells["facture"].Style.BackColor = Color.Yellow;
        ...
        private void buttonItem8_Click(object sender, EventArgs e)
        {
            if (dataGridViewX1.Rows.Count != 0)
            {
                ...
                String ent = "eentl";
                String lent = "lentl";
                String numero = "Bon de Livraison";
                String typedition = "L";
        ...
        private void buttonItem9_Click(object sender, EventArgs e)
        {
            if (dataGridViewX1.Rows.Count != 0)
            {
                impetatliv form = new impetatliv();
                form.ShowDialog();
            }
