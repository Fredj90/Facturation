...
{
    public partial class facturecld : System.Windows.Forms.Form
    {
        ...
        private double MNTNETHT = 0, MNTREM = 0, MNTFODEC = 0, MNTTVA = 0, MNTNETTTC = 0,MNTTAXE=0;
        ...
        private void loadF()
        {
            ...
            string req4 = "select distinct  l.num,l.codea, a.libelle , g.libelle as gamme , d.libelle as depot , l.qte , l.pu , l.tva,l.taxe , l.tvaf , l.rem , l.netht , l.netttc,l.codesa,l.codeg,l.coded,l.codea as codeart,l.ID from lentl l , article a , gamme g , depot d where l.codes='" + Program.Societe + "' and l.codee='" + Program.Exercice + "' and  l.codem='" + Program.Magasin + "' and l.codea = a.code and l.codes= a.codes and l.codee= a.codee and l.codea = g.codea and l.codeg=g.codeg  and l.codes=g.codes and l.codee=g.codee and l.coded= d.code and l.codes=d.codes and l.codee=d.codee and l.codem=d.codem ";
            string tmp = " and (";
            tmp += "l.num = '" + Lnum + "'";
            tmp += ")";
            req4 += tmp;
            ...
            if (!f)
            {
                ds4 = met.recuperer_table(req4, "lentl");
                foreach (DataRow dr in ds4.Tables["lentl"].Rows)
                {
                ...
                dgv_fact.DataSource = ds4.Tables["lentl"].DefaultView;
                string reqcl = "Select * From eentl where codes='" + Program.Societe + "' and codee='" + Program.Exercice + "' and num = '" + Lnum + "'";
                DataSet dscli = met.recuperer_table(reqcl, "eentl");
                if(dscli!=null)
                    if(dscli.Tables.Count!=0)
                        if (dscli.Tables["eentl"].Rows.Count != 0)
                        {
                            Tnomc.Text = dscli.Tables["eentl"].Rows[0].Field<object>("nomc")+"";
                            Tcodc.Text = dscli.Tables["eentl"].Rows[0].Field<object>("codec") + "";
                            Tadrc.Text = dscli.Tables["eentl"].Rows[0].Field<object>("adrc") + "";
 ...
 # region // Région Sauvegarde
        ...
        private void buttonX3_Click(object sender, EventArgs e)
        {
            ...
            if (dgv_fact.Rows.Count != 0)
            {
              ...
              " `DATEC`, `TOTALHT`, `fodec`, `TOTALREM`, `TOTALTVA`,TOTALTAXE,`TIMBRE` ,`TOTALTTC`,RESTE,Type,mode,Valide,REGLE) VALUES ("
              + "'" + Program.User + "',"
              + "'" + Program.Societe + "',"
              + "'" + Program.Exercice + "',"
              + "'" + Program.Magasin + "',"
                ...
                if (Lnum != "")
                    {
                        string sql = "INSERT INTO nblfacture (`codes`, `codee`, `codem`, `NUMF`, `NUML`) VALUES ("
                                         ...
                                         + ")";
                        met.Execute(sql);
                        string sqlmodif = "UPDATE eentl SET facture = true   where codes='" + Program.Societe + "' and codee = '" + Program.Exercice + "' and codem = '" + Program.Magasin + "' and num = '" + Lnum + "'";
            ...
            if (e.KeyData != Keys.Enter)
            {
                if (Tcodc.Text != "")
                {
                    ...
                    if (cli.TimbreFactClient)
                    {
                     ...
                     string req20 = "select num,date,totalttc from eentl where codes = '" + Program.Societe + "' and codee = '" + Program.Exercice + "' and codem = '" + Program.Magasin + "'  and codec= '" + Tcodc.Text + "' and facture = false ";
                     ...
                     if (ds != null)
                     {
                         if (ds.Tables.Count != 0)
                         {
                             ...
                             else
                             {
                                 ...
                                 Total();
                                 MessageBox.Show("Client n'a pas de BL à Facturer");
                             }
                         }
                     }
