...
namespace EPME
{
    public partial class secteura : DevComponents.DotNetBar.Office2007Form
    {
        ...
        private void secteura_KeyDown(object sender, KeyEventArgs e)
        {
            //////////////
            switch (e.KeyCode)
            {
        ...
        private void secteura_Load(object sender, EventArgs e)
        {
            Program.desTfunction(this);
            String req = "SELECT * FROM secteura where codes='" + Program.Societe + "' and codee = '" + Program.Exercice + "' and codem = '" + Program.Magasin + "' Order by code ";
            ds = met.recuperer_table(req, "secteura");
            if (ds != null)
        ...
        private void buttonItem3_Click(object sender, EventArgs e)
        {
            ...
            if (ds.Tables[0].Rows.Count != 0)
            {
                ...
                String req2 = "SELECT * FROM emplacement where codes='" + Program.Societe + "' and codee = '" + Program.Exercice + "' and codem = '" + Program.Magasin + "' and codesec='" + textBox1.Text + "' ";
                ...
                {
                    MessageBox.Show("Suppression Impossible, Secteur Utilisée");
                }
            }
            else
            {
        ...
        private void buttonX2_Click(object sender, EventArgs e)
        {
            ...
            if (superValidator1.Validate())
            {
                ...
                String sql = "SELECT code FROM secteura where codes='" + Program.Societe + "' and codee = '" + Program.Exercice + "' and codem = '" + Program.Magasin + "' and code='" + textBox1.Text + "'";
                ...
                if (!modif)
                {
                    ...
                    if (test)
                    {
                        String req = "INSERT INTO secteura(codes,codee,codem,code,libelle) Values ('" + Program.Societe + "','" + Program.Exercice + "','" + Program.Magasin + "','" + textBox1.Text + "', '" + textBox2.Text + "')";
                        met.Execute(req);
                        ...
                        if (anum >= xnum)
                        {
                            ...
                            for (int ii = l2; ii < l1; ii++)
                                s = "0" + s;
                            string sqlinc = "UPDATE pnum SET secteur = '" + s + "' where codes='" + Program.Societe + "' and codee = '" + Program.Exercice + "' and codem = '" + Program.Magasin + "'";
                            met.Execute(sqlinc);
                        }

                        MessageBox.Show("Sauvegarde éffectué");

                        String req1 = "SELECT * FROM secteura where codes='" + Program.Societe + "' and codee = '" + Program.Exercice + "' and codem = '" + Program.Magasin + "' Order by code ";
                        ds = met.recuperer_table(req1, "secteura");

                        string req5 = "SELECT MAX(ID) from secteura ";
                        DataSet ds2 = met.recuperer_table(req5, "secteura");


                        List<DataColumn> lis = new List<DataColumn>();
                        lis.Add(ds.Tables["secteura"].Columns["ID"]);
                        ds.Tables["secteura"].PrimaryKey = lis.ToArray();
                        DataRow[] dr = ds.Tables["secteura"].Select("ID = '" + ds2.Tables[0].Rows[0].ItemArray[0] + "'");
                        if (dr.Length != 0)
                        {
                ...
                else
                {
                    ...
                    {
                        // Mode Modification
                        String req = "Update secteura Set codes='" + Program.Societe + "',codee='" + Program.Exercice + "',codem='" + Program.Magasin + "',code = '" + textBox1.Text + "', libelle = '" + textBox2.Text + "' Where ID = " + ds.Tables[0].Rows[index].ItemArray[0];
        ...
        private void buttonX4_Click(object sender, EventArgs e)
        {
            ...
            if (msg.Equals("Yes"))
            {
                ...
                String req = "DELETE FROM secteura Where ID = " + ds.Tables[0].Rows[index].ItemArray[0];
                if (met.Execute(req))
        ...
        private void secteura_FormClosed(object sender, FormClosedEventArgs e)
        {
