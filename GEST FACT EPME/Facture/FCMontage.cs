...
{
    public partial class FCMontage : DevComponents.DotNetBar.Office2007Form
    {
                   ...
                   foreach (string  str in LSTid)
                   {
                       ...
                       if(dsdd.Tables.Count!=0)
                           if (dsdd.Tables[0].Rows.Count != 0)
                           {
                               ...
                               mygrid1.Rows[i].Cells["U"].Value = "TN";
                               mygrid1.Rows[i].Cells["PUHTF"].Value = dr["PUPoids"];
