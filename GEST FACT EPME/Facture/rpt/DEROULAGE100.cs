...
namespace EPME.Facture.rpt {
    ...
    public class DEROULAGE100 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "EPME.Facture.rpt.DEROULAGE100.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedDEROULAGE100 : Component, ICachedReport {
        
        public CachedDEROULAGE100() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            DEROULAGE100 rpt = new DEROULAGE100();
            rpt.Site = this.Site;
            return rpt;
        }
