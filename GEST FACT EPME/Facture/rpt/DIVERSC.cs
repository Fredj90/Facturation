...
namespace EPME.Facture.rpt {
    ...
    public class DIVERSC : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "EPME.Facture.rpt.DIVERSC.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedDIVERSC : Component, ICachedReport {
        
        public CachedDIVERSC() {
        }
