...
namespace EPME.Facture.rpt {
    ...
    public class Fondation100 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "EPME.Facture.rpt.Fondation100.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedFondation100 : Component, ICachedReport {
        
        public CachedFondation100() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Fondation100 rpt = new Fondation100();
            rpt.Site = this.Site;
            return rpt;
        }
