...
{
    public partial class frm_fondation : DevComponents.DotNetBar.Office2007Form
    {
        public String numf = "";
        public frm_fondation()
        {
            InitializeComponent();
        }
        ...
        private void frm_fondation_Load(object sender, EventArgs e)
        {
            ...
            sql = "select* from lfondation where numf = '" + numf + "' and codes='" + Program.Societe + "' and codee = '" + Program.Exercice + "'";
            Program.met.recuperer_table(sql, ds, "lfondation");
            ...
            Fondation100 editdevis1 = new Fondation100();
