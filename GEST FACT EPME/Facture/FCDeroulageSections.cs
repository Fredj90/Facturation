...
{
    public partial class FCDeroulageSections : DevComponents.DotNetBar.Office2007Form
    {
       ...
       public FCDeroulageSections()
        ...
        {
            String sql = "UPDATE lcontrat set proratad = proratad + " + tprorata.Text + " WHERE ID = " + ID;
            met.Execute(sql);
        }
        ...
        private void FDeroulage_Load(object sender, EventArgs e)
        {
            act = false;
                       ...
                       if(dsdd.Tables.Count!=0)
                           if (dsdd.Tables[0].Rows.Count != 0)
                           {
                               ...
                               if (!frst)
                               {
                                   ...
                                   mygrid1.Rows[i].Cells["VBP"].Value = dr["PORTEE"];
                                   mygrid1.Rows[i].Cells["U"].Value = "KM";
                                   mygrid1.Rows[i].Cells["PUHTF"].Value = dr["PUDEROULAGE"];
                                   //mygrid1.Rows[i].Cells["PTHT"].Value = dr["PTHT"];ordre
                                   mygrid1.Rows[i].Cells["TVAFF"].Value = 18;
                                   mygrid1.Rows[i].Cells["ID"].Style.BackColor = Color.LightSlateGray;
                                   mygrid1.Rows[i].Cells["Npylon"].Style.BackColor = Color.LightSlateGray;
                                   mygrid1.Rows[i].Cells["TypePylone"].Style.BackColor = Color.LightSlateGray;
                               ...
                               mygrid1.Rows[i].Cells["ordre"].Value = dr["ordre"];
                               mygrid1.Rows[i].Cells["VBP"].Style.BackColor = Color.LightSlateGray;
                               mygrid1.Rows[i].Cells["U"].Style.BackColor = Color.LightSlateGray;
                               mygrid1.Rows[i].Cells["PUHTF"].Style.BackColor = Color.LightSlateGray;
                               mygrid1.Rows[i].Cells["PTHT"].Style.BackColor = Color.LightSlateGray;
                               mygrid1.Rows[i].Cells["TVAFF"].Style.BackColor = Color.LightSlateGray;
                               frst = false;
                               if (i != 0)
                               {
                                   section += "-";
